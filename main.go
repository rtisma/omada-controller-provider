...
// can be customized.
//go:generate go run github.com/hashicorp/terraform-plugin-docs/cmd/tfplugindocs generate --provider-name omada
...
func main() {
	...
	opts := providerserver.ServeOpts{
		Address: "registry.terraform.io/your-org/omada",
		Debug:   debug,
	}
